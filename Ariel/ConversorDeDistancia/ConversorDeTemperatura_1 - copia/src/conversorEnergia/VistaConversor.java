...
public class VistaConversor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jSelecBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Kilowatts", "Calorias", "Joules" }));
        getContentPane().add(jSelecBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 160, 130, 20));

        jSelecBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "KWatts", "Calorias", "Joule" }));
        ...
        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/conversorEnergia/img 2.jpg"))); // NOI18N
