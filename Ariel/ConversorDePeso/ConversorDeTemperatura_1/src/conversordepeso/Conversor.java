...
public class Conversor {
    ...
    public String getCelsiusConvertir(String temA,int select){
        ...
        switch(select) {
            ...
            case 1: resultado = Double.parseDouble(temA) * 2.2046228;break;
            case 2: resultado = ( Double.parseDouble(temA) * 35.273962);break;
        }
    ...
    public String getKelvinconvertir(String temA,int select){
        ...
        switch(select) {
            ...
            case 1: resultado = Double.parseDouble(temA) * 0.453592333346094;break;
            case 2: resultado = Double.parseDouble(temA) * 16;break;
        }
            temperaturaConvertida = getLimitarDecimales(resultado);
            laTemperatura = Double.toString(temperaturaConvertida);
        return laTemperatura ;
    ...
    public String getFarengeiConvertir(String temA,int select){
        ...
        switch(select) {
            ...
            case 1: resultado = Double.parseDouble(temA) * 0.028349523084478;break;
            case 2: resultado = Double.parseDouble(temA)* 0.0625;break;
        }
           temperaturaConvertida = getLimitarDecimales(resultado);
            laTemperatura = Double.toString(temperaturaConvertida);
        return laTemperatura ;
