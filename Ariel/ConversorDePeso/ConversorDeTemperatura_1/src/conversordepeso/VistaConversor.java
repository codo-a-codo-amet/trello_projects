...
public class VistaConversor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jSelecBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Kilos", "Libras", "Onzas" }));
        getContentPane().add(jSelecBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 160, 130, 20));

        jSelecBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Kilos", "Libras", "Onzas" }));
        ...
        titulo.setText("Conversor de peso");
        titulo.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        getContentPane().add(titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 0, 360, 60));
        ...
        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/conversordepeso/img3.jpg"))); // NOI18N
