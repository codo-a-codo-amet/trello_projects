 ...
 * @author alumno
 */
public class CalculadoraComboBoxModel implements ListModel<String>, ComboBoxModel<String>{

    protected List<String> combo_list;
    protected Integer elementoSeleccionado;
    
    public CalculadoraComboBoxModel(){
        combo_list = new ArrayList<>();
        elementoSeleccionado = 0;
    }
    
    public CalculadoraComboBoxModel(List<String> combo_list){
