...
//        System.out.println(unCaballo.color());
        ...
        pp.poneTuNombre("Walter");
        System.out.println(pp.dameTuNombre());
        pp.ponTuEdad(41);
        System.out.println(pp.dameTuEdad());
        System.out.println(pp.dameTuColorRopa());
        
        Profesor unProfesor = new Profesor();
        unProfesor.poneTuNombre("Juan");
        System.out.println(unProfesor.dameTuNombre());
